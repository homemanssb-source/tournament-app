                ...
                <div key={m.id} className="bg-white rounded-xl border overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    {m.locked_by_participant ? (
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          type="text" placeholder="6:4"
                          value={scores[m.id] || ''}
                          onChange={e => setScores({ ...scores, [m.id]: e.target.value })}
                        ...
                        <button onClick={() => submitScore(m.id)}
                          ...
                          className="bg-amber-500 text-white font-bold px-5 py-3 rounded-lg hover:bg-amber-600 disabled:opacity-50 transition-all whitespace-nowrap">
                          {submitting === m.id ? '...' : '제출'}
                        </button>
                      </div>
                    )}
