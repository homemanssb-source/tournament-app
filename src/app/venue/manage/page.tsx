    ...
    <div className={`rounded-xl border-2 p-3 transition-all ${badgeStyle}`}>
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-1 flex-shrink-0 ml-1">
          ...
          {onMoveUp && (
            <button onClick={onMoveUp} className="text-stone-300 hover:text-stone-600 px-0.5 text-sm">▲</button>
          )}
          {onMoveDown && (
            <button onClick={onMoveDown} className="text-stone-300 hover:text-stone-600 px-0.5 text-sm">▼</button>
          )}
